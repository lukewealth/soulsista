    ...
    >
      ...
      <div className="p-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 bg-forest/5 hover:bg-forest/10 rounded-xl transition-all duration-300 group"
        >
          ...
          >
            <ChevronDown className="w-5 h-5 text-forest group-hover:text-gold transition-colors" />
          </motion.div>
        </button>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {service.benefits.map((benefit, index) => (
                      <motion.div
                        ...
                        className="flex items-start gap-3 p-3 bg-forest/5 rounded-lg"
                      >
                  ...
                  <div className="space-y-3">
                    {service.whatToExpect.map((expectation, index) => (
                      <motion.div
                        ...
                        transition={{ delay: index * 0.1 }}
                        className="flex gap-3 p-4 bg-surface-container rounded-xl"
                      >
                        <div className="flex-shrink-0 w-8 h-8 bg-gold text-forest rounded-full flex items-center justify-center font-bold">
                          {index + 1}
                        </div>
                        <div>
                          <h5 className="font-semibold text-forest mb-1">
                            {expectation.title}
                          </h5>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {service.perfectFor.map((item, index) => (
                      <motion.span
                        ...
                        className="px-4 py-2 bg-gold/10 text-forest rounded-full text-sm font-medium"
                      >
                        {item}
                      </motion.span>
                    ))}
                ...
                <div className="pt-4 border-t border-forest/10">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 py-3 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 py-3 bg-forest hover:bg-forest/90 text-ivory font-semibold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                    >
